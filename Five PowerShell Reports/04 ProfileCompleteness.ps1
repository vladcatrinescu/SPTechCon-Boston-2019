...
ConvertTo-EnhancedHTML -HTMLFragments $PictureInfo, $ManagerInfo, $AlluserInfo, $SPInfo -CssUri 'C:\PowerShell\CSS\styles2.css' -PreContent "<H1>Profile Completeness Report on $date</H1>" | Out-File "C:\PowerShell\Profile.html"
