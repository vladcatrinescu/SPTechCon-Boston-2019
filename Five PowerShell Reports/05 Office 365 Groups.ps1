...
$TenantName =  Get-AzureADTenantDetail | Select-Object -ExpandProperty DisplayName
...
ConvertTo-EnhancedHTML -HTMLFragments $ExpiredGroupsInfo, $AllGroupsInfo -CssUri 'C:\PowerShell\CSS\styles2.css' -PreContent "<H1>Office 365 Groups Report for $TenantName on $date</H1>" | Out-File "C:\PowerShell\Groups.html"
